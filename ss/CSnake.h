...
public:
	...
	int color_background, color_border, color_apple, color_normal, color_snake, color_item;  //  colors
	unsigned char  snake, prvSnake, snake_Enlongment;
	int randomX, randomY, apple, item, randomA, randomB;      //  apple
	int level;
